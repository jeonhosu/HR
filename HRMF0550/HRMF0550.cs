...
namespace HRMF0550
{
    public partial class HRMF0550 : Office2007Form
    {
        #region ----- Variables -----
        ...
        public HRMF0550(Form pMainForm, ISAppInterface pAppInterface)
        {
            InitializeComponent();
        ...
        private void XLPrinting_Main()
        {
            ...
            IDC_GET_REPORT_SET_P.SetCommandParamValue("P_ASSEMBLY_ID", "HRMF0550");
            ...
            HRMF0550_PRINT_TYPE vHRMF0550_PRINT_TYPE = new HRMF0550_PRINT_TYPE(isAppInterfaceAdv1.AppInterface);
            vdlgResult = vHRMF0550_PRINT_TYPE.ShowDialog();
            if (vdlgResult == DialogResult.Cancel)
            {
                return;
            }
            string vPRINT_TYPE = iString.ISNull(vHRMF0550_PRINT_TYPE.Get_Printer_Type);
            if (vPRINT_TYPE == string.Empty)
            {
                return;
            }
            vHRMF0550_PRINT_TYPE.Dispose();
        ...
        private void XLPrinting_DTL(string pOutput_Type)
        {
            ...
            {
                //-------------------------------------------------------------------------------------
                xlPrinting.OpenFileNameExcel = "HRMF0550_001.xlsx";
                //-------------------------------------------------------------------------------------
        ...
        private void HRMF0550_Load(object sender, EventArgs e)
        {
