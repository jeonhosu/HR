...
namespace HRMF0322
{
    public class XLPrinting_1
    {
        ...
        private void SetArray1(System.Data.DataTable pTable, out int[] pGDColumn, out int[] pXLColumn)
        {
            ...
            pGDColumn[9] = pTable.Columns.IndexOf("APPROVE_STATUS");    //승인
            pGDColumn[10] = pTable.Columns.IndexOf("APPROVED_PERSON");  //승인자
            pGDColumn[11] = pTable.Columns.IndexOf("DESCRIPTION");      //비고
            ...
            pXLColumn[3] = 19;   //작업장
            pXLColumn[4] = 27;   //업무내용
            pXLColumn[5] = 43;   //출근[근무계획]
            pXLColumn[6] = 48;   //퇴근[근무계획]
            pXLColumn[7] = 53;   //출근[근무시간]
            pXLColumn[8] = 58;   //퇴근[근무시간]
            pXLColumn[9] = 63;   //승인
            pXLColumn[10] = 66;  //승인자
            pXLColumn[11] = 71;  //비고
        }
