...
namespace HRMF0633
{
    public partial class HRMF0633_PAYMENT_PERIOD : Office2007Form
    {
        #region ----- Variables -----
        ...
        public HRMF0633_PAYMENT_PERIOD(ISAppInterface pAppInterface, object pADJUSTMENT_ID, object pWAGE_TYPE, object pYYYY)
        {
            InitializeComponent();
        ...
        {
            idaPAY_PERIOD.SetSelectParamValue("W_ADJUSTMENT_DC_ID", mADJUSTMENT_ID);
            idaPAY_PERIOD.SetSelectParamValue("W_WAGE_TYPE", mWAGE_TYPE);
            idaPAY_PERIOD.SetSelectParamValue("W_SALARY_YYYYMM",  mYYYY);
            idaPAY_PERIOD.Fill();
        }
        ...
        private void HRMF0633_PAYMENT_PERIOD_Load(object sender, EventArgs e)
        {
            idaPAY_PERIOD.FillSchema();
        }

        private void HRMF0633_PAYMENT_PERIOD_Shown(object sender, EventArgs e)
        {
            SEARCH_DB();
        }
