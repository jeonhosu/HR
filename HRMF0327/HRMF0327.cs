...
namespace HRMF0327
{
    public partial class HRMF0327 : Office2007Form
    {
        #region ----- Variables -----
        ...
        public HRMF0327(Form pMainForm, ISAppInterface pAppInterface)
        {
            InitializeComponent();
        ...
        private void HRMF0327_Load(object sender, EventArgs e)
        {
            IDA_PERSON_WEEK_40H.FillSchema();
        }

        private void HRMF0327_Shown(object sender, EventArgs e)
        {
            DefaultValues();
