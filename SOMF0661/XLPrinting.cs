    ...
    public class XLPrinting
    {
        ...
        public int LineWrite(System.Data.DataRow pRow)
        {
            ...
            try
            {
                ...
                if (Convert.ToString(pRow["VENDOR_CODE"]) == "04122")
                {
                    Source1Write(pRow);
                }
                else if (Convert.ToString(pRow["VENDOR_CODE"]) == "05055" ||
                         Convert.ToString(pRow["VENDOR_CODE"]) == "05000" ||
                         Convert.ToString(pRow["VENDOR_CODE"]) == "05007")
                {
                    Source2Write(pRow);
                }
                else if (Convert.ToString(pRow["VENDOR_CODE"]) == "01278")
                {
                    Source3Write(pRow);
                }
                else if (Convert.ToString(pRow["VENDOR_CODE"]) == "01004")
                {
                    Source5Write(pRow);
                }
        ...
        private void Source1Write(System.Data.DataRow pRow)
        {
            //mPageNumber = 0;
            string vMessage = string.Empty;
            ...
            vObject = pRow["CUST_BARCODE"];
            IsConvert = IsConvertString(vObject, out vConvertString);
            if (IsConvert == true)
            {
                vConvertString = string.Format("{0}", vConvertString);
                mPrinting.XLSetCell(1, 1, "*" + vConvertString + "*");
            }
            else
            {
                vConvertString = string.Empty;
            ...
            {
                vConvertString = string.Format("{0}", vConvertString);
                mPrinting.XLSetCell(4, 1, vConvertString);
            }
            else
            {
                vConvertString = string.Empty;
            ...
            {
                vConvertString = string.Format("{0}", vConvertString);
                mPrinting.XLSetCell(5, 5, vConvertString);
            }
            else
            {
                vConvertString = string.Empty;
            ...
            {
                vConvertString = string.Format("{0}", vConvertString);
                mPrinting.XLSetCell(6, 5, vConvertString);
            }
            else
            {
                vConvertString = string.Empty;
            ...
            {
                vConvertString = string.Format("{0:#,###,###,###,###,###,###,###,###,##0}", vConvertDecimal);
                mPrinting.XLSetCell(7, 5, "'" + vConvertString);
            }
            else
            {
                vConvertString = string.Empty;
            ...
            {
                vConvertString = string.Format("{0}", vConvertString);
                mPrinting.XLSetCell(8, 5, vConvertString);
            }
            else
            {
                vConvertString = string.Empty;
            ...
            vObject = pRow["INSPECTOR"];
            IsConvert = IsConvertString(vObject, out vConvertString);
            if (IsConvert == true)
            {
                vConvertString = string.Format("{0}", vConvertString);
                mPrinting.XLSetCell(9, 5, vConvertString);
            }
            else
            {
                vConvertString = string.Empty;
            ...
            {
                vConvertString = string.Format("{0}-{1:D2}-{2:D2}", vDateTime.Year, vDateTime.Month, vDateTime.Day);
                mPrinting.XLSetCell(10, 5, "'" + vConvertString);
            }
            else
            {
                vConvertString = string.Format("{0}-{1:D2}-{2:D2}", vDateTime.Year, vDateTime.Month, vDateTime.Day);
            ...
            vObject = pRow["SHIPPING_WEEK"];
            IsConvert = IsConvertString(vObject, out vConvertString);
            if (IsConvert == true)
            {
                vConvertString = string.Format("{0}", vConvertString);
                mPrinting.XLSetCell(11, 5, vConvertString);
            }
            else
            {
                vConvertString = string.Empty;
        ...
        private void Source2Write(System.Data.DataRow pRow)
        {
            //mPageNumber = 0;
            string vMessage = string.Empty;
            ...
            barcode.Text = string.Format("{0}", pRow["CUST_BARCODE"]);
            ...
            mPrinting.XLBarCode(img, "A1", "A1", vSize, vPoint);

            mPrinting.CountBarCodeImage = 1;
            /////////////////////QR 생성/////////////////////// 
            Syncfusion.Pdf.Barcode.PdfQRBarcode QRcode = new Syncfusion.Pdf.Barcode.PdfQRBarcode();

            QRcode.Version = Syncfusion.Pdf.Barcode.QRCodeVersion.Auto;
            QRcode.ErrorCorrectionLevel = Syncfusion.Pdf.Barcode.PdfErrorCorrectionLevel.High;

            QRcode.XDimension = 5f;
            //Set the barcode text
            QRcode.Text = string.Format("{0}", pRow["CUST_BARCODE"]);

            //Export the barcode as image
            Image QRimg = QRcode.ToImage();

            string vPath = ""; 

            vPath = System.Environment.CurrentDirectory + @"\QRCODE.jpg";
            QRimg.Save(vPath, System.Drawing.Imaging.ImageFormat.Png);


            vSize = new System.Drawing.SizeF(60F, 60F);
            vPoint = new System.Drawing.PointF(365F, 130F);
            mPrinting.XLBarCode(vSize, vPoint, vPath);
            ///////////////////////////////////////////////////
            ...
            vObject = pRow["PO_TYPE"];
            IsConvert = IsConvertString(vObject, out vConvertString);
            if (IsConvert == true)
            {
                vConvertString = string.Format("{0}", vConvertString);
                mPrinting.XLSetCell(6, 8, vConvertString);
            }
            else
            {
                vConvertString = string.Empty;
            ...
            vObject = pRow["PART_NO"];
            IsConvert = IsConvertString(vObject, out vConvertString);
            if (IsConvert == true)
            {
                vConvertString = string.Format("{0}", vConvertString);
                mPrinting.XLSetCell(7, 8, vConvertString);
            }
            else
            {
                vConvertString = string.Empty;
            ...
            {
                vConvertString = string.Format("{0:#,###,###,###,###,###,###,###,###,##0}", vConvertDecimal);
                mPrinting.XLSetCell(10, 8, "'" + vConvertString);
            }
            else
            {
                vConvertString = string.Empty;
            ...
            vObject = pRow["LOT_NO_1"];
            IsConvert = IsConvertString(vObject, out vConvertString);
            if (IsConvert == true)
            {
                vConvertString = string.Format("{0}", vConvertString);
                mPrinting.XLSetCell(9, 8, vConvertString);
            }
            else
            {
                vConvertString = string.Empty;
            ...
            vObject = pRow["WEEK_NUM_1"];
            IsConvert = IsConvertString(vObject, out vConvertString);
            if (IsConvert == true)
            {
                vConvertString = string.Format("{0}", vConvertString);
                mPrinting.XLSetCell(6, 17, vConvertString);
            }
            else
            {
                vConvertString = string.Empty;
        ...
        private void Source3Write(System.Data.DataRow pRow)
        {
            //mPageNumber = 0;
            string vMessage = string.Empty;
            ...
            {
                vConvertString = string.Format("{0}", vConvertString);
                mPrinting.XLSetCell(3, 6, vConvertString);
            }
            else
            {
                vConvertString = string.Empty;
            ...
            {
                vConvertString = string.Format("{0}", vConvertString);
                mPrinting.XLSetCell(4, 6, vConvertString);
            }
            else
            {
                vConvertString = string.Empty;
            ...
            {
                vConvertString = string.Format("{0:#,###,###,###,###,###,###,###,###,##0}", vConvertDecimal);
                mPrinting.XLSetCell(5, 6, "'" + vConvertString);
            }
            else
            {
                vConvertString = string.Empty;
            ...
            {
                vConvertString = string.Format("{0}", vConvertString);
                mPrinting.XLSetCell(6, 6, "'" + vConvertString);
            }
            else
            {
                vConvertString = string.Empty;
        ...
        private void Source5Write(System.Data.DataRow pRow)
        {
            //mPageNumber = 0;
            string vMessage = string.Empty;
            ...
            mPrinting.XLActiveSheet("SOURCE5");
            ...
            //MANUFACTURED DATE
            vObject = pRow["MANUFACTURED_DATE"];
            IsConvert = IsConvertDate(vObject, out vDateTime);
            if (IsConvert == true)
            {
                vConvertString = string.Format("{0}-{1:D2}-{2:D2}", vDateTime.Year, vDateTime.Month, vDateTime.Day);
        ...
        private void Source6Write(System.Data.DataRow pRow)
        {
            //mPageNumber = 0;
            string vMessage = string.Empty;
            ...
            mPrinting.XLActiveSheet("SOURCE6");
        ...
        private void Source7Write(System.Data.DataRow pRow)
        {
            //mPageNumber = 0;
            string vMessage = string.Empty;
            ...
            mPrinting.XLActiveSheet("SOURCE7");
            ...
            string vPath = System.Environment.CurrentDirectory + @"\QRCODE.jpg";
            QRimg.Save(vPath, System.Drawing.Imaging.ImageFormat.Png);


            System.Drawing.SizeF vSize = new System.Drawing.SizeF(100F, 100F);
            System.Drawing.PointF vPoint = new System.Drawing.PointF(10F, 130F);
            mPrinting.XLBarCode(vSize, vPoint, vPath);
            ///////////////////////////////////////////////////

            vObject = pRow["MATERIAL_CODE"];
            IsConvert = IsConvertString(vObject, out vConvertString);
            if (IsConvert == true)
            {
                vConvertString = string.Format("{0}", vConvertString);
                mPrinting.XLSetCell(1, 13, vConvertString);
            }
            else
            {
                vConvertString = string.Empty;
            ...
            vObject = pRow["SDV_PRODUCT"];
            IsConvert = IsConvertString(vObject, out vConvertString);
            if (IsConvert == true)
            {
                vConvertString = string.Format("{0}", vConvertString);
                mPrinting.XLSetCell(2, 13, vConvertString);
            }
            else
            {
                vConvertString = string.Empty;
            ...
            {
                vConvertString = string.Format("{0:#,###,###,###,###,###,###,###,###,##0}", vConvertDecimal);
                mPrinting.XLSetCell(4, 13, "'" + vConvertString);
            }
            else
            {
                vConvertString = string.Empty;
            ...
            vObject = pRow["LOT_NO_3"];
            IsConvert = IsConvertString(vObject, out vConvertString);
            if (IsConvert == true)
            {
                vConvertString = string.Format("{0}", vConvertString);
                mPrinting.XLSetCell(5, 13, vConvertString);
            }
            else
            {
                vConvertString = string.Empty;
            ...
            vObject = pRow["EXPIRATION_DATE"];
            IsConvert = IsConvertString(vObject, out vConvertString);
            if (IsConvert == true)
            {
                vConvertString = string.Format("{0}", vConvertString);
                mPrinting.XLSetCell(6, 13, "'" + vConvertString);
            }
            else
            {
                vConvertString = string.Empty;
            ...
            {
                vConvertString = string.Format("{0}", vConvertString);
                mPrinting.XLSetCell(7, 13, vConvertString);
            }
            else
            {
                vConvertString = string.Empty;
        ...
        private void EtcWrite(System.Data.DataRow pRow)
        {
            string vMessage = string.Empty;
            ...
            //Code
            vObject = pRow["CUST_ITEM_CODE"];
            IsConvert = IsConvertString(vObject, out vConvertString);
            if (IsConvert == true)
            {
                vConvertString = string.Format("{0}", vConvertString);
                mPrinting.XLSetCell(3, 5, vConvertString);
            }
            else
            {
                vConvertString = string.Empty;
            ...
            {
                vConvertString = string.Format("{0}", vConvertString);
                mPrinting.XLSetCell(6, 1, "*" + vConvertString + "*");
            }
            else
            {
                vConvertString = string.Empty;
