...
namespace HRMF0786
{
    public class XLPrinting
    {
        ...
        private int mPrintingLastRow = 165;  //실제 데이터 인쇄 최종 라인.
            ...
            try
            {
                ...
                if (vTotalRow > 0)
                {
                    ...
                    foreach (System.Data.DataRow vRow in pOFFICE_TAX_DOC_SALARY.OraSelectData.Rows)
                    {
                        ...
                        mCurrentRow = LineWrite6(vRow, mCurrentRow); // 현재 위치 인쇄 후 다음 인쇄행 리턴.
                        vPageRowCount = vPageRowCount + 1;
                    ...
                    foreach (System.Data.DataRow vRow in pSALARY_ITEM.OraSelectData.Rows)
                    {
                        ...
                        mCurrentRow = LineWrite3(vRow, mCurrentRow); // 현재 위치 인쇄 후 다음 인쇄행 리턴.
                        vPageRowCount = vPageRowCount + 1;
                    ...
                    foreach (System.Data.DataRow vRow in pSALARY_TAX_FREE_ITEM.OraSelectData.Rows)
                    {
                        ...
                        mCurrentRow = LineWrite4(vRow, mCurrentRow); // 현재 위치 인쇄 후 다음 인쇄행 리턴.
                        vPageRowCount = vPageRowCount + 1;
