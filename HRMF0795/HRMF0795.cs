...
namespace HRMF0795
{
    public partial class HRMF0795 : Office2007Form
    {
        ...
        public HRMF0795(Form pMainForm, ISAppInterface pAppInterface)
        {
            InitializeComponent();
        ...
        private void Encrypt_ExportTXT(string pFileName, string pFILE_TYPE, ISDataAdapter pData)
        {
            ...
            HRMF0795_FILE vHRMF0795_FILE = new HRMF0795_FILE(isAppInterfaceAdv1.AppInterface);
            vdlgResult = vHRMF0795_FILE.ShowDialog();
            if (vdlgResult == DialogResult.OK)
            {
                vENCRYPT_PASSWORD = vHRMF0795_FILE.Get_Encrypt_Password;
            }
        ...
        private void HRMF0795_Load(object sender, EventArgs e)
        {
            DefaultCorporation();
        }

        private void HRMF0795_Shown(object sender, EventArgs e)
        {
        ...
        private void BTN_YEAR_ADJUST_FILE_ButtonClick(object pSender, EventArgs pEventArgs)
        {
            ...
            int vIDX_REC_ADJUST_PERSON_COUNT = IGR_FILE_SUM.GetColumnToIndex("REC_ADJUST_PERSON_COUNT");
            for (int r = 0; r < IGR_FILE_SUM.RowCount; r++)
            {
                if (iConv.ISNull(IGR_FILE_SUM.GetCellValue(r, vIDX_SELECT_YN)) == "Y")
                {
                    ...
                    //생성된 자료수 체크//
                    IDC_GET_FILE_P.SetCommandParamValue("P_OPERATING_UNIT_ID", vOPERATING_UNIT_ID);
                    IDC_GET_FILE_P.ExecuteNonQuery();
                    object vREC_COUNT = IDC_GET_FILE_P.GetCommandParamValue("O_REC_COUNT");
                    
                    IGR_FILE_SUM.SetCellValue(r, vIDX_REC_ADJUST_PERSON_COUNT, vREC_COUNT);
