...
namespace HRMF0779
{
    public partial class HRMF0779 : Office2007Form
    {
        ...
        public HRMF0779(Form pMainForm, ISAppInterface pAppInterface)
        {
            InitializeComponent();
        ...
        private string EXPORT_VALIDATE()
        {
            ...
            if (IGR_RESIDENT_INT_LIST.RowCount < 1)
            {
        ...
        private void ExportTXT(string pFileName, string pFILE_TYPE, ISDataAdapter pData)
        {
            ...
            HRMF0779_FILE vHRMF0779_FILE = new HRMF0779_FILE(isAppInterfaceAdv1.AppInterface);
            vdlgResult = vHRMF0779_FILE.ShowDialog();
            if (vdlgResult == DialogResult.OK)
            {
                vENCRYPT_PASSWORD = vHRMF0779_FILE.Get_Encrypt_Password;
            }
            ...
            else if (pFILE_TYPE == "RESIDENT_INT")
            {
                vFIX_STRING = "B";
            }
        ...
        private void HRMF0779_Load(object sender, EventArgs e)
        {

        }

        private void HRMF0779_Shown(object sender, EventArgs e)
        {
            DefaultCorporation();
        ...
        private void IGR_ADJUST_FILE_LIST_CurrentCellChanged(object pSender, ISGridAdvExChangedEventArgs e)
        {
            ...
            IGR_RESIDENT_INT_LIST.LastConfirmChanges();        
            IDA_RESIDENT_INT_FILE_LIST.OraSelectData.AcceptChanges();
            IDA_RESIDENT_INT_FILE_LIST.Refillable = true;            
        }
        ...
        {
            if (IGR_RESIDENT_INT_LIST.RowIndex < 0)
            {
                return;
            }

            object vOPERATING_UNIT_ID = IGR_RESIDENT_INT_LIST.GetCellValue("OPERATING_UNIT_ID");
        ...
        private void BTN_RESIDENT_INCOME_FILE_ButtonClick(object pSender, EventArgs pEventArgs)
        {
            string vSTATUS;
            string vMESSAGE;
            int vIDX_SELECT_YN = IGR_RESIDENT_INT_LIST.GetColumnToIndex("SELECT_YN");
            int vIDX_OPERATING_UNIT_ID = IGR_RESIDENT_INT_LIST.GetColumnToIndex("OPERATING_UNIT_ID");
            int vIDX_VAT_NUMBER = IGR_RESIDENT_INT_LIST.GetColumnToIndex("VAT_NUMBER");
            int vIDX_TAX_OFFICE_CODE = IGR_RESIDENT_INT_LIST.GetColumnToIndex("TAX_OFFICE_CODE"); 
            for (int r = 0; r < IGR_RESIDENT_INT_LIST.RowCount; r++)
            {
                if (iConv.ISNull(IGR_RESIDENT_INT_LIST.GetCellValue(r, vIDX_SELECT_YN)) == "Y")
                {
                    IGR_RESIDENT_INT_LIST.CurrentCellMoveTo(r, vIDX_SELECT_YN);
                    ...
                    object vOPERATING_UNIT_ID = IGR_RESIDENT_INT_LIST.GetCellValue(r, vIDX_OPERATING_UNIT_ID);
                    string vVAT_NUMBER = iConv.ISNull(IGR_RESIDENT_INT_LIST.GetCellValue(r, vIDX_VAT_NUMBER));
                    object vTAX_OFFICE_CODE = IGR_RESIDENT_INT_LIST.GetCellValue(r, vIDX_TAX_OFFICE_CODE);
                    if (iConv.ISNull(vOPERATING_UNIT_ID) == string.Empty)
                    {
                    ...
                    IDC_SET_RESIDENT_INT.SetCommandParamValue("P_OPERATING_UNIT_ID", vOPERATING_UNIT_ID);
                    IDC_SET_RESIDENT_INT.ExecuteNonQuery();
                    vSTATUS = iConv.ISNull(IDC_SET_RESIDENT_INT.GetCommandParamValue("O_STATUS"));
                    vMESSAGE = iConv.ISNull(IDC_SET_RESIDENT_INT.GetCommandParamValue("O_MESSAGE"));
                    if (vSTATUS == "F")
                    {
                    ...
                    IDA_RESIDENT_INT_FILE.SetSelectParamValue("P_OPERATING_UNIT_ID", vOPERATING_UNIT_ID);
                    IDA_RESIDENT_INT_FILE.Fill();
                    ExportTXT(vVAT_NUMBER, "RESIDENT_INT", IDA_RESIDENT_INT_FILE);
                    IGR_RESIDENT_INT_LIST.SetCellValue(r, vIDX_SELECT_YN, "N");
                }
            }           
        ...
        private void BTN_RESIDENT_INCOME_FILE_DOWN_ButtonClick(object pSender, EventArgs pEventArgs)
        {
            ...
            for (int r = 0; r < IGR_RESIDENT_INT_LIST.RowCount; r++)
            {
                if (iConv.ISNull(IGR_RESIDENT_INT_LIST.GetCellValue(r, vIDX_SELECT_YN)) == "Y")
                {
                    ...
                    IDA_RESIDENT_INT_FILE.SetSelectParamValue("P_OPERATING_UNIT_ID", vOPERATING_UNIT_ID);
                    IDA_RESIDENT_INT_FILE.Fill();
                    ExportTXT(vVAT_NUMBER, "RESIDENT_ETC", IDA_RESIDENT_INT_FILE);
        ...
        private void IDA_eFILE_INFO_NewRowMoved(object pSender, ISBindingEventArgs pBindingManager)
        {
            ...
            IDA_RESIDENT_INT_FILE_LIST.Fill();
        }
        ...
        private void IDA_ADJUST_FILE_LIST_PreNewRowMoved(object pSender, ISBindingEventArgs pBindingManager)
        {
            ...
            {
                IGR_RESIDENT_INT_LIST.GridAdvExColElement[vIDX_SELECT_YN].Insertable = 0;
                IGR_RESIDENT_INT_LIST.GridAdvExColElement[vIDX_SELECT_YN].Updatable = 0;
            }
            else
            {
                IGR_RESIDENT_INT_LIST.GridAdvExColElement[vIDX_SELECT_YN].Insertable = 1;
                IGR_RESIDENT_INT_LIST.GridAdvExColElement[vIDX_SELECT_YN].Updatable = 1;
            }
        }
