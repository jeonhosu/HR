...
namespace HRMF0520
{
    public partial class HRMF0520 : Office2007Form
    {
        #region ----- Variables -----
        ...
        public HRMF0520(Form pMainForm, ISAppInterface pAppInterface)
        {
            InitializeComponent();
        ...
        private void Search_DB()
        {
            ...
            idaSPREAD_PERIOD_SUM.Fill();

            IGR_SPREAD_PERIOD.Focus();
            Application.DoEvents();
            Application.UseWaitCursor = false;

            object vObject1 = idaSPREAD_PERIOD_SUM.GetSelectParamValue("W_CORP_ID");
            object vObject2 = idaSPREAD_PERIOD_SUM.GetSelectParamValue("W_WAGE_TYPE");
            object vObject3 = idaSPREAD_PERIOD_SUM.GetSelectParamValue("W_PAY_YYYYMM");
        }
        ...
        private void HRMF0520_Load(object sender, EventArgs e)
        {
        ...
        private void HRMF0520_Shown(object sender, EventArgs e)
        {
            CompanySearch();
        }
