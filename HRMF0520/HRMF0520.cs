...
namespace HRMF0520
{
    public partial class HRMF0520 : Office2007Form
    {
        ...
        private void Show_Print()
        {
            ...
            //HRMF0520_PRINT vSHOW_PRINT = new HRMF0520_PRINT(isAppInterfaceAdv1.AppInterface
            //                                               , CORP_ID_0.EditValue
        ...
        private void ExportXL(ISGridAdvEx pGrid)
        {
            ...
            if (vCountRows > 0)
            {
                ...
                if (saveFileDialog1.ShowDialog() == System.Windows.Forms.DialogResult.OK)
                {
                    ...
                    string vOpenExcelFileName = "HRMF0520_002.xls";
        ...
        private void XLPrinting1(string CoursePrint)
        {
            ...
            try
            {
                ...
                {
                    xlPrinting.OpenFileNameExcel = "HRMF0520_001.xls";
                }
