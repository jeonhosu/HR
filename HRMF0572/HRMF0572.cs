...
namespace HRMF0572
{
    public partial class HRMF0572 : Office2007Form
    {
        #region ----- Variables -----
        ...
        public HRMF0572(Form pMainForm, ISAppInterface pAppInterface)
        {
            InitializeComponent();
        ...
        private void HRMF0572_Load(object sender, EventArgs e)
        {
            DefaultCorporation();
            // Default_Floor(); 
        }

        private void HRMF0572_Shown(object sender, EventArgs e)
        {
        ...
        private void Set_BTN_STATE()
        {
            ...
            else if (/*mAPPROVE_STATE == String.Empty || */mAPPROVE_STATE == "B")
            {
        ...
        private void BTN_OK_ButtonClick(object pSender, EventArgs pEventArgs)
        {
            ...
            IDC_SET_ALLOWANCE_OP_APPR.ExecuteNonQuery();
            string vSTATUS = iConv.ISNull(IDC_SET_ALLOWANCE_OP_APPR.GetCommandParamValue("O_STATUS"));
            string vMESSAGE = iConv.ISNull(IDC_SET_ALLOWANCE_OP_APPR.GetCommandParamValue("O_MESSAGE"));
            if (vSTATUS == "F")
            {
        ...
        private void BTN_CANCEL_ButtonClick(object pSender, EventArgs pEventArgs)
        {
            ...
            IDC_SET_ALLOWANCE_OP_APPR_CANCEL.ExecuteNonQuery();
            string vSTATUS = iConv.ISNull(IDC_SET_ALLOWANCE_OP_APPR_CANCEL.GetCommandParamValue("O_STATUS"));
            string vMESSAGE = iConv.ISNull(IDC_SET_ALLOWANCE_OP_APPR_CANCEL.GetCommandParamValue("O_MESSAGE"));
            if (vSTATUS == "F")
            {
                if (vMESSAGE != string.Empty)
                {
