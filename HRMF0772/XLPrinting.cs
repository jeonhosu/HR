...
namespace HRMF0772
{
    public class XLPrinting
    {
        ...
        private int mPrintingLastRow = 45;  //실제 데이터 인쇄 최종 라인.

        private int mCurrentRow = 17;        //실제 인쇄되는 row 위치.
        private int mDefaultPageRow = 16;    //페이지 skip후 적용되는 기본 PageCount 기본값.
