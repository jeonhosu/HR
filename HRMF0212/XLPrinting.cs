...
namespace HRMF0212
{
    public class XLPrinting
    {
        ...
        private int mCopy_EndRow = 35;
        private int mPrintingLastRow = 34;  //실제 데이터 인쇄 최종 라인.
        ...
        {// 그리드의 컬럼에 대한 컬럼인덱스 값 산출
            ...
            pGDColumn[12] = pGrid.GetColumnToIndex("RETIRE_NAME");
        ...
        public void HeaderWrite(object pTitle, InfoSummit.Win.ControlAdv.ISDataCommand pPrinted_Value)
        {// 헤더 인쇄.
            ...
            try
            {
                ...
                vXLine = 3;
                vXLColumn = 13;
                vPrinted_Value = pPrinted_Value.GetCommandParamValue("O_PERIOD_DATE");
                mPrinting.XLSetCell(vXLine, vXLColumn, vPrinted_Value);
        ...
        public int ExcelWrite(object pTitle, InfoSummit.Win.ControlAdv.ISDataCommand pPrinted_Value, InfoSummit.Win.ControlAdv.ISGridAdvEx pGrid)
        {// 실제 호출되는 부분.
            ...
            try
            {
                HeaderWrite(pTitle, pPrinted_Value);
