...
namespace HRMF0777
{
    public partial class HRMF0777 : Office2007Form
    {
        ...
        public HRMF0777(Form pMainForm, ISAppInterface pAppInterface)
        {
            InitializeComponent();
        ...
        private void Search_DB_DTL(object pOPERATING_UNIT_ID)
        {
            ...
            IDA_RESIDENT_INCOME_DTL.SetSelectParamValue("P_OPERATING_UNIT_ID", pOPERATING_UNIT_ID);
            IDA_RESIDENT_INCOME_DTL.Fill(); 
        }
        ...
        private void ExportTXT(string pFileName, string pFILE_TYPE, ISDataAdapter pData)
        {
            ...
            HRMF0777_FILE vHRMF0777_FILE = new HRMF0777_FILE(isAppInterfaceAdv1.AppInterface);
            vdlgResult = vHRMF0777_FILE.ShowDialog();
            if (vdlgResult == DialogResult.OK)
            {
                vENCRYPT_PASSWORD = vHRMF0777_FILE.Get_Encrypt_Password;
            }
        ...
        private void HRMF0777_Load(object sender, EventArgs e)
        {

        }

        private void HRMF0777_Shown(object sender, EventArgs e)
        {
            DefaultCorporation();
        ...
        private void IGR_ADJUST_FILE_LIST_CurrentCellChanged(object pSender, ISGridAdvExChangedEventArgs e)
        {
            ...
            IDA_RESIDENT_INCOME_FILE_LIST.OraSelectData.AcceptChanges();
            IDA_RESIDENT_INCOME_FILE_LIST.Refillable = true;            
        }
        ...
        private void BTN_RESIDENT_INCOME_FILE_ButtonClick(object pSender, EventArgs pEventArgs)
        {
            ...
            for (int r = 0; r < IGR_RESIDENT_INCOME_LIST.RowCount; r++)
            {
                if (iConv.ISNull(IGR_RESIDENT_INCOME_LIST.GetCellValue(r, vIDX_SELECT_YN)) == "Y")
                {
                    ...
                    IDC_SET_RESIDENT_INCOME.SetCommandParamValue("P_OPERATING_UNIT_ID", vOPERATING_UNIT_ID);
                    IDC_SET_RESIDENT_INCOME.ExecuteNonQuery();
                    vSTATUS = iConv.ISNull(IDC_SET_RESIDENT_INCOME.GetCommandParamValue("O_STATUS"));
                    vMESSAGE = iConv.ISNull(IDC_SET_RESIDENT_INCOME.GetCommandParamValue("O_MESSAGE"));
                    if (vSTATUS == "F")
                    {
                    ...
                    IDA_RESIDENT_INCOME_FILE.SetSelectParamValue("P_OPERATING_UNIT_ID", vOPERATING_UNIT_ID);
                    IDA_RESIDENT_INCOME_FILE.Fill();
                    ExportTXT(vVAT_NUMBER, "RESIDENT_INCOME", IDA_RESIDENT_INCOME_FILE);
        ...
        private void IDA_eFILE_INFO_NewRowMoved(object pSender, ISBindingEventArgs pBindingManager)
        {
            ...
            IDA_RESIDENT_INCOME_FILE_LIST.Fill();
        }
