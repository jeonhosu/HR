...
namespace HRMF0326
{
    public partial class HRMF0350 : Office2007Form
    {
        #region ----- Variables -----
        ...
        public HRMF0350(Form pMainForm, ISAppInterface pAppInterface)
        {
            InitializeComponent();
        ...
        private void DefaultValues()
        {
            ...
            IDA_PERSON_WEEK_40H.SetSelectParamValue("W_JOB_CATEGORY_ID", 396);
        ...
        private void HRMF0326_Shown(object sender, EventArgs e)
        {
            DefaultValues();
        ...
        private void isButton1_ButtonClick(object pSender, EventArgs pEventArgs)
        {
            ...
            mMessage = iString.ISNull(idcSET_OT.GetCommandParamValue("O_MESSAGE"));
