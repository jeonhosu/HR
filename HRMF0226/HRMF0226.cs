...
namespace HRMF0226
{
    public partial class HRMF0226 : Office2007Form
    {
        #region ----- Variables -----
        ...
        public HRMF0226(Form pMainForm, ISAppInterface pAppInterface)
        {
            InitializeComponent();
        ...
        private void ILA_RNP_TYPE_PrePopupShow(object pSender, ISLookupPopupShowEventArgs e)
        {
            SetCommonParameter("RP_TYPE", "Y");
        }
        ...
        private void HRMF0226_Load(object sender, EventArgs e)
        {
            IDA_REWARD_PUNISHMENT.FillSchema();
        }

        private void HRMF0226_Shown(object sender, EventArgs e)
        {
            DefaultValues();
